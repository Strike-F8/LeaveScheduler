...
namespace LeaveScheduler.Controllers
{
    public class ManagersController : Controller
    {
        ...
        public ManagersController(LeaveSchedulerContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("ManagerID,EmployeeID")] Manager manager)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ManagerID,EmployeeID")] Manager manager)
        {
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'LeaveSchedulerContext.Manager'  is null.");
            }
            var manager = await _context.Manager.FindAsync(id);
            if (manager != null)
            {
